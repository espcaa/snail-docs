---
title: Installation
description: Install Snail on your system
---
...
download the installer on [the repo's releases page](https://github.com/espcaa/snail/releases).
...
no support yet, manual installation :(
